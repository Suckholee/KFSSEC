...
export default function Hero({ onExploreClick, onAboutClick, onScrollNext }) {
  ...
  return (
    <section className="relative overflow-hidden bg-[#070908] text-white border-b-2 border-[#C5A059] shadow-2xl">
      
      {/* Main Wide Banner Showcase - 100% Full Aspect Ratio Preserved, Never Cropped! */}
      <div className="w-full bg-[#050505] flex justify-center items-center pt-3 pb-2 sm:pt-6 sm:pb-4 border-b border-stone-900">
        <div className="w-full max-w-[1500px] px-2 sm:px-4 lg:px-6">
          <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl bg-black border border-stone-800/80">
            <img
              src="/images/main_banner_masters_2x.png"
              srcSet="/images/main_banner_masters.png 1024w, /images/main_banner_masters_2x.png 2048w"
      ...
      <div className="relative z-10 py-6 sm:py-8 px-4 sm:px-8 max-w-7xl mx-auto flex flex-col items-center gap-5 sm:gap-6">
