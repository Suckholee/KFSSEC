...
export default function GreetingsSection({ viewMode = 'all' }) {
  ...
  const profileCards = [
    ...
    {
      id: '03',
      title: t("국가 및 기관 심사위원"),
      icon: Scale,
      subtitle: 'Official Committee Judge',
      items: [
        t("조리기능장, 기능사, 산업기사 2005~2007년 실기심사위원"),
        t("전국 기능올림픽위원회 실기 심사위원"),
        t("지방 기능올림픽위원회 실기 심사위원"),
        t("중국약선협회 약선요리 실기 심사위원"),
        t("세계 음식 박람회 각 단체별 실기 심사위원"),
        t("대한민국 전통주 조주사 국가대표선발전 실기 심사위원"),
      ],
    },
    {
      id: '04',
      ...
      items: [
        t("NCS에 의한 양식조리기능사 Westen Cuisine"),
        t("고급서양조리 The Professional Western Cuisine"),
        t("소비자가 선호하는 외식업체의 고객만족도 요인에 관한 연구"),
        t("호텔레스토랑의 식공간 연출이 고객감정반응과 행동의도에 미치는 영향에 관한 연구"),
      ],
    },
    {
      id: '05',
      ...
      items: [
        t("현) 한국외식창업교육원 교수"),
        t("현) 청년상인 육성재단 청년상인 지원단"),
        t("중소벤처기업부 소상공인지원단 전담교수"),
        t("산업인력관리공단 취업교육 강사(기초기능서비스업)"),
        t("동의대학교 / 한중대학교 외식산업학과 겸임교수"),
        t("창신대학교 / 창원문성대학교 겸임교수"),
        t("창원시 청소년 직업상담 진로교육 상담위"),
      ],
    },
    {
      id: '06',
      title: t("정부 표창 및 주요 수상"),
      icon: Award,
      subtitle: 'Honors & Government Awards',
      items: [
        t("문화체육부 장관상(대상) 2015년 전통음식부분"),
        t("문화체육부 장관상(대상) 2014년 건강음식부분"),
        t("서울특별시장상(우수상) 2014년 일반부 단체부분"),
        t("서울특별시장상(대상) 2013년 라이브 요리 부분"),
        t("중국 남경시 약선요리대회 백금상(2등) 2011년 개인부분"),
        t("한국국제요리경영대회 금상 2010년 향토음식"),
        t("경상남도 도지사상 우수상 / 한국산업인력공단 금상"),
        t("2005산청한방 웰빙요리대회 대상 2005년 개인 종합 최우수 부분"),
      ],
    },
  ];
      ...
      <ScrollReveal direction="up" delay={0}>
        <div className="relative rounded-3xl p-8 sm:p-12 text-white shadow-xl overflow-hidden bg-[#073822] border border-emerald-500/30 min-h-[220px] flex items-center">
          ...
          <div className="relative z-10 max-w-2xl space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-[38px] font-black tracking-tight leading-tight text-white drop-shadow-lg">{t("\" 미래를 선도하는")}<br className="hidden sm:inline" />
              <span className="text-emerald-300">{t("외식산업의 동반자, 한국외식창업교육원")}{' '}</span>"
            </h2>
          </div>
        </div>
      </ScrollReveal>
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <ScrollReveal direction="right" delay={200}>
              <div className="bg-stone-50 p-6 rounded-2xl border border-stone-200/80 space-y-1.5 shadow-xs hover:border-emerald-300 transition-colors">
                <span className="font-extrabold text-gray-900 text-lg sm:text-xl block">{t("안녕하십니까?")}</span>
                <span className="text-gray-700 font-bold text-base block">{t("사단법인")}</span>
                <span className="text-gray-900 font-black text-xl sm:text-2xl block">{t("한국외식창업교육원")}</span>
                <span className="text-[#0F5132] font-black text-xl sm:text-2xl block">{t("이사장 안형상")}<span className="text-gray-800 font-semibold text-base sm:text-lg">{t("입니다.")}</span>
                </span>
              </div>
            </ScrollReveal>
          </div>
          ...
          <div className="lg:col-span-8 space-y-8 text-gray-800 font-medium text-base sm:text-lg lg:text-xl leading-relaxed">
            ...
            <ScrollReveal direction="up" delay={150}>
              <div className="space-y-5 border-b border-gray-100 pb-8">
                ...
                <p className="leading-relaxed">{t("우리는 여러분의 꿈과 비전을 실현할 수 있도록 든든한 동반자로 함께하며, 지속 가능한 외식산업 생태계를 구축하기 위해 노력하고 있습니다.")}{' '}</p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="up" delay={200}>
              <div className="space-y-4 pt-2">
                <h4 className="text-xl sm:text-2xl font-black text-gray-900 inline-block bg-emerald-100/90 text-emerald-950 px-4 py-1.5 rounded-lg">{t("I. 교육원의 운영 목표")}{' '}</h4>
                <p className="text-sm sm:text-base text-gray-600 font-bold">{t("다음과 같은 세 가지 핵심 목표를 중심으로 운영되고 있습니다.")}{' '}</p>
                ...
                <div className="space-y-4 pt-2">
                  <ScrollReveal direction="up" delay={250}>
                    <div className="bg-stone-50 p-5 sm:p-6 rounded-2xl border border-stone-200/80 space-y-2 hover:bg-emerald-50/50 hover:border-emerald-200 transition-all">
                      <h5 className="font-black text-[#0F5132] text-lg sm:text-xl">{t("1. 미래지향적 교육")}{' '}</h5>
                      <p className="text-sm sm:text-base text-gray-700 font-medium leading-relaxed">{t("급변하는 외식산업 트렌드와 기술을 반영한 실용적인 교육을 통해 시대가 요구하는 역량을 갖춘 인재를 양성합니다.")}{' '}</p>
                    </div>
                  </ScrollReveal>

                  <ScrollReveal direction="up" delay={300}>
                    <div className="bg-stone-50 p-5 sm:p-6 rounded-2xl border border-stone-200/80 space-y-2 hover:bg-emerald-50/50 hover:border-emerald-200 transition-all">
                      <h5 className="font-black text-[#0F5132] text-lg sm:text-xl">{t("2. 실전 중심의 통합 솔루션")}{' '}</h5>
                      <p className="text-sm sm:text-base text-gray-700 font-medium leading-relaxed">{t("창업의 첫걸음부터 안정적인 정착에 이르기까지 컨설팅, 멘토링, 마케팅 지원 등 외식 창업 전 과정에 필요한 종합적인 솔루션을 제공합니다.")}{' '}</p>
                    </div>
                  </ScrollReveal>

                  <ScrollReveal direction="up" delay={350}>
                    <div className="bg-stone-50 p-5 sm:p-6 rounded-2xl border border-stone-200/80 space-y-2 hover:bg-emerald-50/50 hover:border-emerald-200 transition-all">
                      <h5 className="font-black text-[#0F5132] text-lg sm:text-xl">{t("3. 상생과 협력의 네트워크")}{' '}</h5>
                      <p className="text-sm sm:text-base text-gray-700 font-medium leading-relaxed">{t("창업자, 소상공인, 그리고 관련 기관 간의 긴밀한 협력 체계를 구축하여 외식산업 전반의 경쟁력을 높이고 지역사회 발전에 기여합니다.")}{' '}</p>
                    </div>
                  </ScrollReveal>
                </div>
              </div>
            ...
            <ScrollReveal direction="up" delay={300}>
              <div className="space-y-4 pt-6 border-t border-gray-100">
                <h4 className="text-xl sm:text-2xl font-black text-gray-900 inline-block bg-emerald-100/90 text-emerald-950 px-4 py-1.5 rounded-lg">{t("II. 맺음말")}{' '}</h4>
                <p className="leading-relaxed">{t("외식업은 지속적인 도전과 열정을 필요로 하는 영역입니다. 하지만 올바른 길을 제시하고 함께 고민해 주는 파트너가 있다면, 도전은 더 이상 두려움이 아닌 성공의 시작이 될 것입니다.")}{' '}</p>
                <p className="leading-relaxed">{t("한국외식창업교육원은 여러분의 열정이 결실을 맺을 수 있도록 늘 곁에서 최고의 교육과 지원을 아끼지 않을 것을 약속드립니다.")}{' '}</p>
                <p className="leading-relaxed font-bold text-gray-900">{t("여러분의 원대한 꿈과 도전이 이곳 한국외식창업교육원에서 시작되기를 진심으로 응원합니다.")}{' '}</p>
                <p className="leading-relaxed pt-2 font-black text-[#0F5132]">{t("감사합니다.")}{' '}</p>
                ...
                <div className="pt-6 flex justify-end">
                  <div className="text-right space-y-1 bg-emerald-50/60 px-6 py-4 rounded-2xl border border-emerald-100 inline-block shadow-xs">
                    <span className="text-xs text-gray-500 font-bold block">{t("사단법인 한국외식창업교육원")}</span>
                    <span className="text-[#0F5132] font-black text-xl sm:text-2xl">{t("이사장 안 형 상")}{' '}</span>
                  </div>
                </div>
              </div>
            </ScrollReveal>
